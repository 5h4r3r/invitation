...
const items = [
  { q: 'Будет ли трансфер?', a: 'Да, мы организуем трансфер для гостей от парковки ТРЦ «Воробьёвы Горы». Сбор в 14:30.' },
  { q: 'Есть ли парковка?', a: 'Да, рядом с рестораном есть бесплатная парковка.' },
  { q: 'До какого числа нужно подтвердить?', a: 'Пожалуйста, подтвердите участие до 1 августа 2026 года, чтобы мы могли учесть всех гостей при подготовке.' },
  ...
  { q: 'Будут ли фотограф и видеограф?', a: 'Да, у нас будут профессиональные фотограф и видеограф. Все фото и видео вы сможете получить после свадьбы.' },
]
