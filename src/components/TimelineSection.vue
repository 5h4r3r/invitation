...
const schedule = [
  { time: '15:30', title: 'Сбор гостей', desc: 'Приветственный фуршет, легкая музыка и теплые объятия' },
  { time: '16:00', title: 'Церемония бракосочетания', desc: 'Самый трогательный момент — произнесение клятв' },
  { time: '17:00', title: 'Фуршет и фотосессия', desc: 'Время для поздравлений, объятий и памятных снимков' },
  { time: '18:00', title: 'Праздничный ужин', desc: 'Изысканные угощения, душевные тосты и веселые интерактивы' },
  { time: '21:30', title: 'Свадебный торт', desc: 'Традиционное разрезание торта и уютное чаепитие' },
  { time: '22:00', title: 'Танцы и развлечения', desc: 'Зажигательная музыка и незабываемая атмосфера' },
]
